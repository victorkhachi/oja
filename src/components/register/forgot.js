    ...
    return (
        <div className='page' style={{ backgroundColor: ' #E5E5E5;' }}>
            ...
            <div style={{ zIndex: '400', position: 'absolute', width: '100%' }}>
              ...
              <Link to='/signIn' style={{position: 'absolute', width: '15%', height: '50px', margin: '15 % 0px 0px 5%' }} className='back'><i class=" fa-2x fas fa-arrow-left" style={{ width: '50px' }}></i></Link>
