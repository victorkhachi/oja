...
export default function Cart2() {
    ...
    return (
        <div style={{  height: '700px', overflowY: 'scroll',boxshadow:'0px 4px 4px 0px #00000040',padding:'2%',background:'white'}}>
            ...
            <div style={{ display: 'flex', width: '99%',height:'400px',overflow:'scroll', justifyContent: 'space-between', flexBasis: '45%', flexWrap: 'wrap', margin: 'auto', position: 'relative', marginTop: '2%' }}>
                {
                ...
                <Link to='/note' style={{
                     textDecoration: 'none', width: '20%', padding: '2%', position: 'absolute', top: '70%', right:'5%'
                }}>
                    <Note />
                </Link>
            </div>
